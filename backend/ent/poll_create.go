...
func (pc *PollCreate) SetStatus(s string) *PollCreate {
	pc.mutation.SetStatus(s)
	return pc
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (pc *PollCreate) SetNillableStatus(s *string) *PollCreate {
	if s != nil {
		pc.SetStatus(*s)
	}
	return pc
...
func (pc *PollCreate) SetUserID(id int) *PollCreate {
	pc.mutation.SetUserID(id)
	return pc
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (pc *PollCreate) SetNillableUserID(id *int) *PollCreate {
	if id != nil {
		pc = pc.SetUserID(*id)
	}
	return pc
...
func (pc *PollCreate) SetUser(u *User) *PollCreate {
...
func (pc *PollCreate) check() error {
	...
	if _, ok := pc.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`ent: missing required field "Poll.status"`)}
	}
