...
func (pq *PollQuery) QueryUser() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, poll.UserTable, poll.UserColumn),
		)
...
func (pq *PollQuery) WithUser(opts ...func(*UserQuery)) *PollQuery {
	query := (&UserClient{config: pq.config}).Query()
...
func (pq *PollQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Poll, error) {
	...
	if query := pq.withUser; query != nil {
		if err := pq.loadUser(ctx, query, nodes, nil,
			func(n *Poll, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
...
func (pq *PollQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Poll, init func(*Poll), assign func(*Poll, *User)) error {
